        ...
        if event["type"] == "INPUT":
            ...
            try:
                ...
                if input_id == "transcription":
                    ...
                    print_event(
                        "✅ TTS",
                        f"Segment {segment_index + 1} complete (status: {status}, remaining: {segments_remaining})",
                        Colors.GREEN,
                    )
                    ...
                    print_event(
                        "🎵 AUDIO",
                        f"Segment {segment_index + 1}, {duration:.2f}s @ {sample_rate}Hz (streaming: {is_streaming})",
                        Colors.CYAN,
                    )
